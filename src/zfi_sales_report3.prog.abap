...
*&
*&---------------------------------------------------------------------*
REPORT zfi_sales_report3.

INCLUDE zdata_structure_fields3. " DATA
INCLUDE zfi_sales_report3_api. " ALV
INCLUDE zfi_sales_report3_subroutine. " FORMS
INCLUDE zfi_sales_report3_sadad. " API
...
*  PERFORM ALL_EVENT.
  ...
  PERFORM check_auth.
  PERFORM calc_data.
  PERFORM create_api_data_and_display.
...
*    vbkd~prsdt,
  ...
  left join ZSADAD_LOG on
     ZSADAD_LOG~XBLNR = bkpf~xblnr and
     zsadad_log~status = '4'
