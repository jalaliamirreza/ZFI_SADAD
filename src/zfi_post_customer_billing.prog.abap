*&---------------------------------------------------------------------*
*& Report ZFI_POST_CUSTOMER_BILLING
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zfi_post_customer_billing.
...
DATA: gv_it_output TYPE TABLE OF zfi_post_customer_billing,
      gv_wa_output LIKE LINE OF  gv_it_output,
      gv_it_log    TYPE TABLE OF zfi_post_customer_billing_log,
...
SELECT-OPTIONS: s_belnr FOR payr-vblnr,
                s_budat FOR bkpf-budat." OBLIGATORY NO-EXTENSION NO INTERVALS.
...
FORM build_fieldcatalog .
  ...
  CALL FUNCTION 'REUSE_ALV_FIELDCATALOG_MERGE'
    EXPORTING
      i_structure_name = 'ZFI_POST_CUSTOMER_BILLING'
    CHANGING
...
FORM post_with_clear CHANGING lv_subrc     TYPE      sy-subrc
  ...
  PERFORM fill_ftpost TABLES lv_it_ftpost USING 'K' 1 'BKPF-BKTXT' 'واريز نقدي خرده فروشي'.
...
FORM display_log .
  ...
  CALL FUNCTION 'REUSE_ALV_FIELDCATALOG_MERGE'
    EXPORTING
      i_structure_name = 'ZFI_POST_CUSTOMER_BILLING_LOG'
    CHANGING
